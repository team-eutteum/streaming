  ...
  list: [
    {
      ...
      content: [
        {
          title: '스밍은 왜 하나요?',
          body: '<p>스트리밍 횟수는 각 음원사이트의 실시간·일간·연간 차트와 음악방송, 시상식 점수에 모두 반영돼요.</p><p><span class="-b">음원차트 순위 유지</span>와 <span class="fc-pointRed -b">음악방송 및 연말 시상식 수상에 꼭</span> 필요합니다.</p>',
        },
        {
          title: '스밍은 어디서 하나요?',
        ...
        },
        {
          ...
          body: '<p><span class="-b">음총팀 X계정·웹사이트에 공지되는 권장 스밍리스트</span>를 확인해주세요.<br /> <span class="-b">리스트대로 들어주셔야</span> 음원차트·써클차트·음방 순위·시상식 점수에 <span class="-b">최대 효율로 반영</span>됩니다.<br /> 스밍리스트대로 재생하기 <span class="-b">어렵다면</span>, 한 시간에 한 번 또는 <span class="-b">하루 한 번만 들어주셔도</span> 큰 도움이 됩니다.</p>',
        },
        {
          title: '뮤직웨이브(뮤웨)가 뭐예요?',
          body: '<p>멜론 앱과 웹사이트에서 제공하는 채팅 + 플레이리스트 기능입니다.<br /> <span class="-b">종종 라이즈가 채팅하러 오는 그 곳</span>이 바로 뮤직웨이브입니다.<br /> 멜론 이용권이 있는 브리즈가 뮤웨에 입장해 있기만 해도 앱으로 스밍하는 것과 동일한 효과가 있습니다.</p>',
        },
        {
          title: '공식 뮤웨와 음총 뮤웨 차이는 무엇인가요?',
          body: '<p>공식 뮤웨는 멜론이 제공하는 기본방, <span class="-b">음총 뮤웨는 음총팀이 운영하는 최적화 스밍방</span>입니다.<br /> 멜론 <span class="fc-pointRed -b">이용권만 있으면</span> 복잡한 설정 없이 <span class="fc-pointRed -b">입장만으로 자동 스밍 효과</span>를 얻을 수 있어요.<br /> 재생목록이 같다면 공식 뮤웨와 음총 뮤웨 모두 동일하게 차트에 반영되니 편한 곳에 계시면 됩니다.<br /> 만약 리스트가 다르다면 권장 스밍리스트대로 재생되는 음총팀 뮤웨 입장을 권장합니다.</p>',
        },
        {
          title: '뮤웨 창 꺼도 스밍되나요? 화면 켜놔야 하나요?',
          body: '<p>네. <span class="-b">멜론앱</span>을 <span class="fc-pointRed -b">종료하지만 않는다면</span> <span class="-b">백그라운드에서도 재생</span>됩니다.<br /> 화면을 꺼두시거나 홈버튼을 통해 앱을 내려두시거나 뮤직웨이브 내 화살표를 통해 뮤웨 창을 내려두셔도 스밍됩니다.</p>',
        },
        {
          title: '뮤웨도 설정이 필요한가요?',
          body: '<p>아니요. <span class="fc-pointRed -b">음량 2 이상(음소거 금지)</span> 외에는 추가 설정이 필요 없습니다.<br /> 댓글 참여 여부도 음원차트 순위에는 영향이 없으니 편하게 입장해 계시면 됩니다.</p>',
        },
        {
        ...
        {
          title: '소리를 꺼도 되나요?',
          body: '<p>음량 0은 집계 안 될 수 있으니 <span class="fc-pointRed -b">최소 2 이상 유지</span><span class="-b">해주세요.</span> </p><p><span class="-b">이어폰을 연결</span>해두시거나, 안드로이드의 경우 <span class="-b">사운드어시스턴트 앱 - 개별앱 음량 조절(5% 이상 권장)</span>을 통해 소리가 들리지 않도록 하시는 방법을 추천드립니다.</p>',
        },
        {
        ...
        },
        {
          ...
          body: '<ul class="bullet-list"><li class="list">기감: 기계적 스밍이 감지되었다는 알림 → 보안코드를 입력하면 재생 재개</li><li class="list">지듣계: “지금 듣고계신 음악을 계속 재생하시겠습니까?” 알람 → 예(확인) 클릭하면 재생 재개</li></ul><p>⚠️ 팝업이 떴는데 <span class="-b">처리하지 않으면 스밍이 계속 끊긴 상태</span>로 유지되니, 주기적으로 스밍이 끊기지 않았는지 <span class="-b">확인해주세요.</span></p>',
        },
      ],
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          body: '<p>스테이션헤드 앱 설치 후 실행 > 스포티파이 또는 애플뮤직 연동<span class="-b f-underline">(이용권 필수)</span> > <span class="-b fc-pointRed">BRIIZE 채널 또는 riizestreamjp 채널 입장</span></p>',
        },
        {
      ...
      content: [
        {
          ...
          body: '<p>다운로드는 <span class"-b">차트 반영과 시상식 점수에 큰 비중</span>을 차지합니다.</p><p>특히 멜론차트는 <span class="fc-pointRed">다운로드 60%</span> + 스밍 40% 비율로 반영되므로, 음원차트 진입과 시상식 점수에 다운로드가 매우 중요합니다.</p>',
        },
        {
          title: '음원 결제만 하면 되나요? 다운로드는 생략해도 되나요?',
          body: '<p>아니요. 결제 후 실제 <span class="-b">파일까지 다운로드해야 차트에 반영</span>됩니다. </p><p>반드시 다운로드 완료까지 확인해주세요.</p>',
        },
        {
